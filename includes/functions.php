            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"><tr>
                ...
                <td class="mp-stack mp-mobile-top" width="46%" valign="top">
                    <div class="mp-light-bg" style="background:#ffffff;background-image:linear-gradient(#ffffff,#ffffff);border:1px solid #dde5f0;border-radius:18px;overflow:hidden;box-shadow:0 20px 55px rgba(8,24,50,.14);">
                        ...
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#0d2347;color:#ffffff;"><tr><td align="center" style="padding:11px 8px;border-right:1px solid rgba(255,255,255,.12);font-size:10px;font-weight:700;color:#ffffff;"><span style="color:' . $accent . ';font-size:17px;">' . $iconSymbol('P', $accent, 17) . '</span><br><span style="font-size:8px;color:' . $muted . ';font-weight:700;">' . $esc('bottom1') . '</span></td><td align="center" style="padding:11px 8px;border-right:1px solid rgba(255,255,255,.12);font-size:10px;font-weight:700;color:#ffffff;"><span style="color:' . $accent . ';font-size:17px;">' . $iconSymbol('Q', $accent, 17) . '</span><br><span style="font-size:8px;color:' . $muted . ';font-weight:700;">' . $esc('bottom2') . '</span></td><td align="center" style="padding:11px 8px;font-size:10px;font-weight:700;color:#ffffff;"><span style="color:' . $accent . ';font-size:17px;">' . $iconSymbol('B', $accent, 17) . '</span><br><span style="font-size:8px;color:' . $muted . ';font-weight:700;">' . $esc('bottom3') . '</span></td></tr></table>
                    </div>
                </td>
            </tr></table>
        </td></tr>';
