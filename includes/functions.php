...
function mailpilotBuilderPremiumBlockHtml($block, $state) {
    ...
    if ($type === 'premiumPlumberHeader') {
        ...
        return '<tr><td class="mp-light-bg" bgcolor="#ffffff" background="assets/uploads/mailpilot-icons/email-white-bg.png" style="padding:' . $padding . 'px 28px 18px 28px;background-color:#ffffff;background-image:url(&quot;assets/uploads/mailpilot-icons/email-white-bg.png&quot;);background-repeat:repeat;font-family:' . mailpilotBuilderAttr($fontStack) . ';">
    ...
    if ($type === 'premiumPlumberHeroScore') {
        ...
        if ($cardImage === '' || stripos($cardImage, '/plumber-email-image.jpg') !== false) {
            $cardImage = 'assets/uploads/mailpilot-icons/plumber-card-background.jpg';
        }
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"><tr>
                ...
                <td class="mp-stack mp-mobile-top" width="46%" valign="top">
                    <div class="mp-light-bg" style="background:#ffffff;background-image:linear-gradient(#ffffff,#ffffff);border:1px solid #dde5f0;border-radius:18px;overflow:hidden;box-shadow:0 20px 55px rgba(8,24,50,.14);">
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"' . $cardBackgroundAttribute . ' style="' . $cardBackgroundStyle . '"><tr><td valign="top" style="padding:17px 20px 22px 20px;height:154px;background-color:rgba(11,29,58,.46);">
                        ...
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" background="assets/uploads/mailpilot-icons/email-white-bg.png" class="mp-light-bg" style="background-color:#ffffff;background-image:url(&quot;assets/uploads/mailpilot-icons/email-white-bg.png&quot;);background-repeat:repeat;"><tr><td style="padding:18px 18px 14px 18px;"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td width="38%" align="center" valign="middle" style="padding-right:12px;"><div style="width:98px;height:98px;border-radius:50%;background:' . $accent . ';padding:7px;box-shadow:0 18px 40px rgba(244,124,32,.18);"><div style="width:84px;height:84px;border-radius:50%;background:#ffffff;background-image:linear-gradient(#ffffff,#ffffff);text-align:center;padding-top:22px;"><div style="font-size:24px;line-height:1;font-weight:700;letter-spacing:-1px;color:#0b1d3a;">' . $esc('score') . '</div><div style="font-size:11px;font-weight:700;color:#4a6080;">/ 100</div></div></div><div style="font-size:8px;color:#4a6080;font-weight:700;padding-top:8px;letter-spacing:.08em;text-transform:uppercase;line-height:1.3;">' . $esc('scoreLabel') . '</div></td><td width="62%" valign="middle"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">' . $row($get('check1Title'), $get('check1Text'), 'scorecard-cta-visibility') . $row($get('check2Title'), $get('check2Text'), 'scorecard-mobile-quote') . $row($get('check3Title'), $get('check3Text'), 'scorecard-trust-proof', false) . '</table></td></tr></table></td></tr></table>
...
function getEmbeddedImages($html) {
    ...
    // Match image sources and table background attributes under assets/uploads/.
    preg_match_all('/(?:src|background)=["\']([^"\']*assets\/uploads\/([^"\']+))["\']/i', $html, $matches);
